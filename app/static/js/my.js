...
This repository
Search
Watch 219 Star 3, 650 Fork 383 openstf / stf
Code Issues 87 Pull requests 7 Wiki Pulse Graphs
Branch: master Find file Copy pathstf / res / app / components / stf / screen / screen - directive.js
a3f815c on 19 Jan
@gunta gunta Fix all res / files with ESLint rules with 0 errors.
2 contributors @gunta @sorccu
RawBlameHistory 939 lines(786 sloc) 28.7 KB
var _ = require('lodash')
var rotator = require('./rotator')
var ImagePool = require('./imagepool')

module.exports = function DeviceScreenDirective(
    $document, ScalingService, VendorUtil, PageVisibilityService, $timeout, $window
) {
    return {
        restrict: 'E',
